  ...
  const renderContent = () => {
    switch (activeCategory) {
      ...
      case 'Ігристі вина':
        ...
        return (
          <ul>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>GREEN DAY</p>
        <p  className='price'>220₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>NEMIROFF</p>
        <p  className='price'>250₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>FINLANDIA</p>
        <p  className='price'>600₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>ABSOLUTE</p>
        ...
        return (
          <ul>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>JACK DANIELS</p>
        <p  className='price'>100₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>JAMESON</p>
        <p  className='price'>120₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>RED LABLE</p>
        <p  className='price'>90₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>JIM BEAM</p>
        ...
        return (
          <ul>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>BACARDI OAKHEART</p>
        <p  className='price'>75₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>CARTA NEGRA</p>
        <p  className='price'>75₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>CARTA BLANKA 75</p>
        <p  className='price'>75₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>CARTAIN MORGAN</p>
        <p  className='price'>75₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>CAPTAIN MORGAN BLACK</p>
        <p  className='price'>75₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>SPICED</p>
        <p  className='price'>75₴</p>
        </li>
      </ul>
        );
        ...
        return (
          <ul>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>OLD KAKHETI</p>
        <p  className='price'>400₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>ADJARI</p>
        <p  className='price'>340₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>SHUSTOFF CHOCOLATIER</p>
        <p  className='price'>220₴</p>
        </li>
      </ul>
        );
        ...
        return (
          <ul>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>SIERRA SILVER</p>
        <p  className='price'>80₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>OLMEGA</p>
        <p  className='price'>90₴</p>
        </li>
      </ul>
        );
        ...
        return (
          <ul>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>BEEFEATER</p>
        <p  className='price'>90₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>FINSBURY PLATINUM</p>
        <p  className='price'>90₴</p>
        </li>
      </ul>
        );
        ...
        return (
          <ul>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>MARTINI ROSSO</p>
        <p  className='price'>100₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>MARTINI BIANCO</p>
        <p  className='price'>100₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>MARTINI DRY</p>
        <p  className='price'>90₴</p>
        </li>
      </ul>
        );
        ...
        return (
          <ul>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>BECHEROVKA</p>
        <p  className='price'>70₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>JAGERMEISTER</p>
        <p  className='price'>90₴</p>
        </li>
      </ul>
        );
        ...
        return (
          <ul>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>CORONA EXTRA</p>
        <p  className='price'>90₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>GARAGE</p>
        <p  className='price'>60₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>HOEGAARDEN</p>
        <p  className='price'>110₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>HIKE</p>
        <p  className='price'>60₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>STELLA ARTOIS</p>
        <p  className='price'>80₴</p>
        </li>
      </ul>
        );
        ...
        return (
          <ul>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>COCA-COLA 0.5</p>
        <p  className='price'>80₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>COCA-COLA 0.33</p>
        <p  className='price'>35₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>COCA-COLA 0.33 ж/б</p>
        <p  className='price'>45₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>FANTA 0.33 ж/б</p>
        <p  className='price'>35₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>BORJOMI</p>
        <p  className='price'>90₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>RED BULL</p>
        <p  className='price'>80₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>BON AQUA</p>
        <p  className='price'>40₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>NON STOP</p>
        <p  className='price'>45₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>Сік в асортименті</p>
        <p  className='price'>100₴</p>
        </li>
      </ul>
        );
        ...
        return (
          <ul>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>ESPRESSO</p>
        <p  className='price'>25₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>AMERICANO</p>
        <p  className='price'>30₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>RAFF</p>
        <p  className='price'>80₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>LATTE</p>
        <p  className='price'>60₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>CAPPUCHINO</p>
        <p  className='price'>40₴</p>
        </li>
        <li className='bar-items'><img src={MartiniAsti} alt='APEROL SPRITZ' className='bar-img'/><p>TEA</p>
        <p  className='price'>35₴</p>
        </li>
      </ul>
        );
